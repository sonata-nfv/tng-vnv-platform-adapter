      ...
      when {
        ...
        stage('Generating release') {
          steps {
            ...
            sh 'docker tag registry.sonata-nfv.eu:5000/tng-vnv-platform-adapter:latest sonatanfv/tng-vnv-platform-adapter:v5.0'
            sh 'docker push registry.sonata-nfv.eu:5000/tng-vnv-platform-adapter:v5.0'
            sh 'docker push sonatanfv/tng-vnv-platform-adapter:v5.0'
          }
        }
        ...
        steps {
          ...
          sh 'git clone https://github.com/sonata-nfv/tng-devops.git'
          dir(path: 'tng-devops') {
                sh 'ansible-playbook roles/vnv.yml -i environments -e "target=sta-vnv-v5-0 component=tng-vnv-platform-adapter"'
          }
        }
		    }
    }   
